...
#### finally, pyx issues are is removed from here. 
#from pyx import unit		### only little need for pyx, I hope: stuff to be encapsulated in Visualiser and procSeq2PDF completely
...
#			print "as fetched", path
			path = os.path.abspath(path)
#			print "as fetched2", path
			path = os.path.join(path,imagecollectionSelectedFile)
#			print "as fetched3", path
		...
		#print inpoint,outpoint,textPageLen,graphPageLen
